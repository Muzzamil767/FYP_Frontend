      ...
      <div className="login-page">
        <div className="login-container">
          ...
          <p className="not-member">
            Not a member? <Link className="sign-up-link" to="/signUp">Sign up</Link>
          </p>
          <p className="not-member">
            Not a Register as a Doctor? <Link className="sign-up-link" to="/signUpDoctor">Sign up Doctor</Link>
          </p>
        </div>
      </div>
      <Footer1 />
