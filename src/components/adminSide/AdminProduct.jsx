...
const AdminProduct = () => {
  ...
  const handleSaveProduct = () => {
    ...
    fetch(`/api/v1/admin/product/${editProductId}`, {
      method: 'PUT',
      headers: {
        'Content-Type': 'application/json',
      },
      ...
      .then((responseData) => {
        if (responseData.success) {
          ...
          const updatedData = data.map((product) =>
            product._id === editProductId ? { ...product, ...editedProductData } : product
          );
          setData(updatedData);
      ...
      <div className='container'>
        {editProductId !== null && (
          ...
          <div className='modal-content'>
            ...
            <h2  style={{ textAlign: "center", justifyContent: "center", margin: "30px" }}>Edit Product</h2>
            ...
            <label>Name: </label>
              ...
              <input
                ...
                onChange={(e) => setEditedProductData({ ...editedProductData, stock: e.target.value })}
                required
              /></div><br/>
              <div className='form-group'>
